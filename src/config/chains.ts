...
export const CHAINS: ChainConfig[] = [
  {
    ...
    name: 'Base',
    nativeSymbol: 'ETH',
    rpcs: ['https://mainnet.base.org', 'https://base-rpc.publicnode.com', 'https://base.drpc.org', 'https://1rpc.io/base', 'https://base.meowrpc.com'],
  ...
  },
  {
    ...
    name: 'Arbitrum One',
    nativeSymbol: 'ETH',
    rpcs: ['https://arb1.arbitrum.io/rpc', 'https://arbitrum-one-rpc.publicnode.com', 'https://arbitrum.drpc.org', 'https://1rpc.io/arb', 'https://arbitrum.meowrpc.com', 'https://arbitrum.publicnode.com'],
  ...
  },
  {
    ...
    nativeSymbol: 'ETH',
    rpcs: ['https://ethereum-rpc.publicnode.com', 'https://eth.drpc.org', 'https://1rpc.io/eth', 'https://eth.merkle.io', 'https://mainnet.gateway.tenderly.co', 'https://ethereum.publicnode.com'],
  ...
  },
  {
    ...
    name: 'Sepolia',
    nativeSymbol: 'ETH',
    rpcs: ['https://ethereum-sepolia-rpc.publicnode.com', 'https://ethereum-sepolia.publicnode.com', 'https://sepolia.gateway.tenderly.co', 'https://1rpc.io/sepolia'],
